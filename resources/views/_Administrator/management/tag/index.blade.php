...
<div class="row">
    <div class="col-sm-12">
        <div class="btn-group pull-right m-t-15">
            <button class="btn btn-default waves-effect waves-light" id="btn-modal"><i class="fa fa-plus"></i> Add Tag</button>
        </div>

        <h4 class="page-title">List Tags</h4>
        <ol class="breadcrumb">
            <li>
                <a href="#">Tags</a>
            </li>
...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            ...
            <div class="p-20">
                <table class="table m-0" id="data-table" data-url="{{ url('administrator/management/tag/source') }}" data-column="[
    ...
    <div class="modal-dialog"> 
        ...
        <div class="modal-content"> 
            <div class="modal-header"> 
                ...
                <h4 class="modal-title"><span id="title-status">Add</span> New Tag</h4> 
            </div> 
