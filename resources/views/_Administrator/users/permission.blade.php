...
<div class="row">
    <div class="col-sm-12">
        <div class="btn-group pull-right m-t-15">
            <button class="btn btn-default waves-effect waves-light" id="btn-modal"><i class="fa fa-plus"></i> Add Permission</button>
        </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            ...
            <div class="p-20">
                <table class="table m-0" id="data-table" data-url="{{ url('administrator/permission/users/source') }}" data-column="[
    ...
    <div class="modal-dialog"> 
        ...
        <div class="modal-content"> 
            <div class="modal-header"> 
                ...
                <h4 class="modal-title"><span id="title-status">Add</span> New Permission</h4> 
            </div> 
